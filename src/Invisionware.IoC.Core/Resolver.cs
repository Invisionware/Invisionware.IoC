...
namespace Invisionware.IoC
{
	...
	public static class Resolver
	{
		...
		/// <exception cref="InvalidOperationException">IResolver instance has not been set.</exception>
		public static T Resolve<T>(dynamic constructorArgs = null) where T : class
		{
			return Instance.Resolve<T>(constructorArgs);
		}
		...
		/// <exception cref="InvalidOperationException">IResolver instance has not been set.</exception>
		public static object Resolve(Type type, dynamic constructorArgs = null)
		{
			return Instance.Resolve(type, constructorArgs);
		}
		...
		/// <exception cref="InvalidOperationException">IResolver instance has not been set.</exception>
		public static IEnumerable<T> ResolveAll<T>(dynamic constructorArgs = null) where T : class
		{
			return Instance.ResolveAll<T>(constructorArgs);
		}
		...
		/// <exception cref="InvalidOperationException">IResolver instance has not been set.</exception>
		public static IEnumerable<object> ResolveAll(Type type, dynamic constructorArgs = null)
		{
			return Instance.ResolveAll(type, constructorArgs);
		}
		...
		/// <summary>
		/// Gets a value indicating whether this instance provides support for constructor arguments.
		/// </summary>
		/// <value><c>true</c> if this instance is constructor arguments supported; otherwise, <c>false</c>.</value>
		public static bool IsConstructorArgsSupported => Instance.IsConstructorArgsSupported;
	}
}
